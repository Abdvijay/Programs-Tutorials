...
POINTS TO REMEMBER :
    ...
    3. ANOTHER ADVANTAGE IS IF WE INSERT NEW ROW THEN THE HIGH_EARNERS ALWAYS FETCH IT AND UPDATED IT IF THE QUERY IS SATISFIED AND WE DONT RUN ABOVE EMPLOYEES MANAUALLY.